...
function LoginCard() {
    ...
    return (
        <div className="max-w-xs mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <h2 className="block text-primary text-xl font-bold mb-2">Log In</h2>
            ...
            <div className="my-2 rounded border-2 border-blue-500 text-primary font-bold hover:bg-blue-50 focus:shadow">
